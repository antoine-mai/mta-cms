...
class Loader
{
    ...
    {
        Error::logMessage('debug', 'Loader Class Initialized');
    }
     ...
     * Autoload
     *
     * Registers a spl_autoload_register for Admin namespaces and immediately
    ...
    public static function handleAutoload($class)
    {
        ...
        $baseDir = dirname(__DIR__);
        $relativeClass = substr($class, 6); // Remove 'Admin\'
