...
<body
    class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white font-display min-h-screen flex flex-col overflow-x-hidden">
    <!-- Top Navigation Bar -->
    <header
        ...
        <div class="px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center gap-10">
                ...
                <nav class="hidden md:flex items-center gap-1">
                    <a class="px-4 py-2 text-sm font-medium text-primary bg-primary/10 rounded-lg transition-colors"
                        href="#">Overview</a>
                    <a class="px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors"
                        href="#">Analytics</a>
                    <a class="px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors"
                        href="#">Projects</a>
                    <a class="px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors"
            ...
            <div class="flex items-center gap-4">
                <div
                    class="hidden lg:flex w-64 xl:w-80 h-10 bg-slate-100 dark:bg-slate-800 rounded-lg items-center px-3 border border-transparent focus-within:border-primary transition-all">
                    <span class="material-symbols-outlined text-slate-400 text-[20px]">search</span>
                    <input
                        class="bg-transparent border-none focus:ring-0 text-sm w-full text-slate-900 dark:text-white placeholder-slate-400 h-full"
                        placeholder="Search..." type="text" />
                </div>
                <div class="flex items-center gap-2">
                    <button
                        class="hidden sm:flex h-10 px-4 bg-primary hover:bg-primary/90 text-white text-sm font-bold rounded-lg items-center justify-center transition-colors">
                        <span class="material-symbols-outlined text-[18px] mr-2">add</span>
                        Create New
                    </button>
                    <button
                        class="size-10 flex items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 transition-colors relative">
                    ...
                    <button
                        class="size-10 flex items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 transition-colors">
                        <span class="material-symbols-outlined text-[20px]">settings</span>
                    </button>
                    <div class="w-10 h-10 rounded-full bg-cover bg-center ml-2 border-2 border-white dark:border-slate-800 shadow-sm cursor-pointer"
    ...
    <main class="flex-1 w-full max-w-[1920px] mx-auto p-6 lg:p-8 flex flex-col gap-6">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <p class="text-slate-500 dark:text-slate-400 mt-1">Welcome back, here is your daily performance summary.
                </p>
            </div>
            <div class="flex flex-wrap gap-3">
                <button
                    class="flex items-center gap-2 h-9 px-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Stat Card 1 -->
            <div
                class="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col justify-between h-full group hover:border-primary/50 transition-colors">
                <div class="flex justify-between items-start mb-4">
                    <div class="p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-primary">
                        <span class="material-symbols-outlined">payments</span>
                    </div>
                    <span
                        class="flex items-center text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/20 px-2 py-1 rounded text-xs font-bold">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 h-auto">
            <!-- Main Chart -->
            <div
                class="lg:col-span-2 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 flex flex-col">
                <div class="flex justify-between items-start mb-6">
                    <div>
                        ...
                        <div class="flex items-center gap-2 mt-1">
                            ...
                            <span
                                class="text-emerald-600 dark:text-emerald-400 text-sm font-medium bg-emerald-50 dark:bg-emerald-900/20 px-2 py-0.5 rounded">+8.5%</span>
                        </div>
                    </div>
                    <select
                        class="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 text-sm rounded-lg focus:ring-primary focus:border-primary block p-2">
                ...
                <div class="flex-1 w-full relative min-h-[300px]">
                    ...
                    <svg class="w-full h-full" preserveaspectratio="none" viewbox="0 0 800 300">
                        ...
                        <!-- Grid Lines -->
                        <line class="text-slate-100 dark:text-slate-700" stroke="currentColor" stroke-width="1" x1="0"
                            x2="800" y1="250" y2="250"></line>
                        <line class="text-slate-100 dark:text-slate-700" stroke="currentColor" stroke-width="1" x1="0"
                            x2="800" y1="190" y2="190"></line>
                        <line class="text-slate-100 dark:text-slate-700" stroke="currentColor" stroke-width="1" x1="0"
                            x2="800" y1="130" y2="130"></line>
                        <line class="text-slate-100 dark:text-slate-700" stroke="currentColor" stroke-width="1" x1="0"
                            x2="800" y1="70" y2="70"></line>
                        <!-- Area -->
                        <path d="M0,250 Q100,200 200,220 T400,150 T600,100 T800,50 V250 H0 Z"
                            fill="url(#chartGradient)"></path>
                        <!-- Line -->
                        <path d="M0,250 Q100,200 200,220 T400,150 T600,100 T800,50" fill="none" stroke="#135bec"
            ...
            <!-- Secondary Chart -->
            <div
                class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 flex flex-col">
        ...
        <div
            ...
            <div
                class="p-6 border-b border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="flex gap-2 w-full sm:w-auto">
                    <div class="relative flex-1 sm:w-64">
                        ...
                        <input
                            class="pl-9 w-full h-9 text-sm bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 rounded-lg focus:ring-primary focus:border-primary placeholder-slate-400 text-slate-900 dark:text-white"
                            placeholder="Search projects..." type="text" />
                    </div>
                    <button
                        class="h-9 px-3 flex items-center gap-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr
                            class="bg-slate-50 dark:bg-slate-700/30 border-b border-slate-200 dark:border-slate-700 text-xs uppercase text-slate-500 dark:text-slate-400 font-semibold tracking-wider">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700 text-sm">
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <div
                                        class="size-6 rounded-full bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center text-xs font-bold text-indigo-700 dark:text-indigo-300">
                                        JD</div>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <div
                                        class="size-6 rounded-full bg-teal-100 dark:bg-teal-900/50 flex items-center justify-center text-xs font-bold text-teal-700 dark:text-teal-300">
                                        AS</div>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <div
                                        class="size-6 rounded-full bg-orange-100 dark:bg-orange-900/50 flex items-center justify-center text-xs font-bold text-orange-700 dark:text-orange-300">
                                        MR</div>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <div
                                        class="size-6 rounded-full bg-pink-100 dark:bg-pink-900/50 flex items-center justify-center text-xs font-bold text-pink-700 dark:text-pink-300">
                                        SL</div>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <div
                                        class="size-6 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-xs font-bold text-gray-700 dark:text-gray-300">
                                        DK</div>
            ...
            <div
                ...
                <div class="flex gap-2">
                    <button
                        class="px-3 py-1.5 text-sm border border-slate-200 dark:border-slate-700 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-white dark:hover:bg-slate-700 disabled:opacity-50"
                        disabled="">Previous</button>
                    <button
                        class="px-3 py-1.5 text-sm border border-slate-200 dark:border-slate-700 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-white dark:hover:bg-slate-700">Next</button>
                </div>
            </div>
        </div>
    </main>
