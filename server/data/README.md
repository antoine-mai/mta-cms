...
### Posts Table
Stores all blog posts with title, slug, content, author, etc.

### Pages Table
Stores static pages with templates and SEO metadata.
...
1. Add table creation SQL to `server/data/tables/your_table.sql`
2. Run migration to create the table: `./bin/migrate`
