<?php namespace Root\Services\Upload;
/**
 * Upload Class
 * 
...
class Upload
{
	...
	public function __construct($config = [])
	{
		...
		$this->_mimes =& \Root\Core\Common::getMimes();
		$this->_mta =& \Root\Core\Controller::getInstance();
		error_log( 'Upload Class Initialized');
	}
	...
	public function validate_upload_path()
	{
		...
		if ( ! \Root\Core\Common::isReallyWritable((string)$this->upload_path))
		{
