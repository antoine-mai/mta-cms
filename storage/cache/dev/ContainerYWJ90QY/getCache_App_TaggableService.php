...
class getCache_App_TaggableService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).'/server/vendor/symfony/cache/Adapter/TagAwareAdapterInterface.php';
        include_once \dirname(__DIR__, 4).'/server/vendor/symfony/cache-contracts/TagAwareCacheInterface.php';
        include_once \dirname(__DIR__, 4).'/server/vendor/symfony/cache/Adapter/TagAwareAdapter.php';
