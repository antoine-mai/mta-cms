...
class getContainer_EnvVarProcessorService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).'/server/vendor/symfony/dependency-injection/EnvVarProcessorInterface.php';
        include_once \dirname(__DIR__, 4).'/server/vendor/symfony/dependency-injection/EnvVarProcessor.php';
