...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Modules\\Users\\Controller\\Admin\\UserController' => 'getUserControllerService',
            ...
            'doctrine.dbal.users_connection' => 'getDoctrine_Dbal_UsersConnectionService',
            'doctrine.orm.default_entity_manager' => 'getDoctrine_Orm_DefaultEntityManagerService',
            'doctrine.orm.users_entity_manager' => 'getDoctrine_Orm_UsersEntityManagerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/server/vendor/doctrine/persistence/src/Persistence/ConnectionRegistry.php';
            include_once \dirname(__DIR__, 4).'/server/vendor/doctrine/persistence/src/Persistence/ManagerRegistry.php';
            include_once \dirname(__DIR__, 4).'/server/vendor/doctrine/persistence/src/Persistence/AbstractManagerRegistry.php';
            include_once \dirname(__DIR__, 4).'/server/vendor/symfony/doctrine-bridge/ManagerRegistry.php';
            include_once \dirname(__DIR__, 4).'/server/vendor/doctrine/doctrine-bundle/src/Registry.php';
            include_once \dirname(__DIR__, 4).'/server/vendor/symfony/doctrine-bridge/Middleware/IdleConnection/Listener.php';
            include_once \dirname(__DIR__, 4).'/server/vendor/symfony/doctrine-bridge/Middleware/Debug/DebugDataHolder.php';
            include_once \dirname(__DIR__, 4).'/server/vendor/doctrine/doctrine-bundle/src/Middleware/BacktraceDebugDataHolder.php';
            include_once \dirname(__DIR__, 4).'/server/vendor/symfony/cache/Adapter/ArrayAdapter.php';
            ...
            include_once \dirname(__DIR__, 4).'/server/vendor/doctrine/doctrine-bundle/src/Twig/DoctrineExtension.php';
            ...
            include_once \dirname(__DIR__, 4).'/server/vendor/symfony/doctrine-bridge/DataCollector/DoctrineDataCollector.php';
            include_once \dirname(__DIR__, 4).'/server/vendor/doctrine/doctrine-bundle/src/DataCollector/DoctrineDataCollector.php';
    ...
    protected static function getDataCollector_CacheService($container)
    {
        ...
        $instance->addInstance('cache.doctrine.orm.users.result', ($container->privates['cache.doctrine.orm.users.result'] ?? self::getCache_Doctrine_Orm_Users_ResultService($container)));
        $instance->addInstance('cache.doctrine.orm.users.query', ($container->privates['cache.doctrine.orm.users.query'] ?? self::getCache_Doctrine_Orm_Users_QueryService($container)));
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\IndexController', 'App\\Controller\\Admin\\LoginController', 'App\\Controller\\HomeController', 'App\\Modules\\Users\\Controller\\Admin\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private 'cache.doctrine.orm.users.query' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected static function getCache_Doctrine_Orm_Users_QueryService($container)
    {
        return $container->privates['cache.doctrine.orm.users.query'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Symfony\Component\Cache\Adapter\ArrayAdapter(), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }

    /**
     * Gets the private 'cache.doctrine.orm.users.result' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected static function getCache_Doctrine_Orm_Users_ResultService($container)
    {
        return $container->privates['cache.doctrine.orm.users.result'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Symfony\Component\Cache\Adapter\ArrayAdapter(), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/server/vendor/doctrine/doctrine-bundle/templates'), 'Doctrine');
        $a->addPath((\dirname(__DIR__, 4).'/server/vendor/doctrine/doctrine-bundle/templates'), '!Doctrine');
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'DoctrineBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/server/vendor/doctrine/doctrine-bundle'),
            ...
            'doctrine.entity_managers' => [
                ...
                'users' => 'doctrine.orm.users_entity_manager',
            ],
            ...
            'doctrine.connections' => [
                ...
                'users' => 'doctrine.dbal.users_connection',
            ],
