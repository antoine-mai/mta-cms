...
class getDoctrine_UlidGeneratorService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).'/server/vendor/doctrine/orm/src/Id/AbstractIdGenerator.php';
        include_once \dirname(__DIR__, 4).'/server/vendor/symfony/doctrine-bridge/IdGenerator/UlidGenerator.php';
