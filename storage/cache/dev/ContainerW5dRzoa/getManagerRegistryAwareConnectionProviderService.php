...
class getManagerRegistryAwareConnectionProviderService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).'/server/vendor/doctrine/dbal/src/Tools/Console/ConnectionProvider.php';
        include_once \dirname(__DIR__, 4).'/server/vendor/doctrine/doctrine-bundle/src/Dbal/ManagerRegistryAwareConnectionProvider.php';
